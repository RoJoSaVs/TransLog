...
pronombre(plural,masculino,primera,["nosotros"], ["we"]).
pronombre(plural,masculino,segunda,["vosotros"], ["you"]).
pronombre(plural,masculino,tercera,["ellos"], ["they"]).
pronombre(plural,femenino,tercera,["ellas"], ["they"]).
